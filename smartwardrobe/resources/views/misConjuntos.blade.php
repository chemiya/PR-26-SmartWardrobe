...
<body>
	...
	<div>
		...
		<div id='menu' class="w-full block flex-grow lg:flex lg:items-center lg:w-auto ">
			<div class="text-sm lg:flex-grow flex md:justify-end flex-col md:flex-row justify-center">
				<a href="/registrarConjunto" class="bg-white cursor-pointer p-3 mr-3 my-2  rounded-full text-2xl font-bold">
					Registrar conjunto
				</a>
				<a href="/misPrendas" class="bg-white cursor-pointer p-3 me-3 my-2 rounded-full text-2xl font-bold">
					Mis prendas
				</a>
	...
	<div class="container mx-auto">
		<h1 class="text-6xl font-bold text-center morado-texto">Mis conjuntos</h1>

		@empty($conjuntos)
		<p class="text-3xl font-bold text-center mt-3">No tienes ningún conjunto guardado.</p>
		@else
		<div class="prendas-div flex justify-center items-center flex-wrap">
			@foreach($conjuntos as $conjunto)
			<div class="prenda-ext p-5 md:w-1/3 w-full">
				<a href="/detalleConjunto/{{$conjunto->id}}">
					<div class="prenda-interior morado rounded-lg p-5 flex flex-col justify-center items-center">
						...
						<h1 class="mt-3 font-bold text-3xl text-white">{{$conjunto->nombre}}</h1>
						<h1 class="mt-3 font-bold text-xl text-white">{{$conjunto->numeroPrendas}} prendas</h1>
